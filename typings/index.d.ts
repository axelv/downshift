...
/* useSlateSuggest Types */
export interface UseSlateSuggestState<Item> {
  highlightedIndex: number
  selectedItem: Item | null
  isOpen: boolean
  inputValue: string
...
export enum UseSlateSuggestStateChangeTypes {
...
export interface UseSlateSuggestProps<Item> {
  items: Item[]
  focusEditor: ()=>void 
  itemToString?: (item: Item | null) => string
  getA11yStatusMessage?: (options: A11yStatusMessageOptions<Item>) => string
  ...
  scrollIntoView?: (node: HTMLElement, menuNode: HTMLElement) => void
  stateReducer?: (
    state: UseSlateSuggestState<Item>,
    actionAndChanges: UseSlateSuggestStateChangeOptions<Item>,
  ) => Partial<UseSlateSuggestState<Item>>
  onSelectedItemChange?: (changes: UseSlateSuggestStateChange<Item>) => void
  onIsOpenChange?: (changes: UseSlateSuggestStateChange<Item>) => void
  onHighlightedIndexChange?: (changes: UseSlateSuggestStateChange<Item>) => void
  onStateChange?: (changes: UseSlateSuggestStateChange<Item>) => void
  environment?: Environment
}

export interface UseSlateSuggestStateChangeOptions<Item>
  extends UseSlateSuggestDispatchAction<Item> {
  changes: Partial<UseSlateSuggestState<Item>>
}

export interface UseSlateSuggestDispatchAction<Item> {
  type: UseSlateSuggestStateChangeTypes
  shiftKey?: boolean
  getItemNodeFromIndex?: (index: number) => HTMLElement
  inputValue?: string
  index?: number
...
export interface UseSlateSuggestStateChange<Item>
  extends Partial<UseSlateSuggestState<Item>> {
  type: UseSlateSuggestStateChangeTypes
}

export interface UseSlateSuggestGetMenuPropsOptions
  extends GetPropsWithRefKey,
    GetMenuPropsOptions {}

export interface UseSlateSuggestGetToggleButtonPropsOptions
  extends GetPropsWithRefKey,
    GetToggleButtonPropsOptions {}

export interface UseSlateSuggestGetLabelPropsOptions extends GetLabelPropsOptions {}

export interface UseSlateSuggestGetItemPropsOptions<Item>
  extends GetItemPropsOptions<Item>,
    GetPropsWithRefKey {}

export interface UseSlateSuggestGetInputPropsOptions
  extends GetInputPropsOptions,
    GetPropsWithRefKey {}

export interface UseSlateSuggestGetComboboxPropsOptions
  extends React.HTMLProps<HTMLDivElement> {}

export interface UseSlateSuggestPropGetters<Item> {
  getToggleButtonProps: (
    options?: UseSlateSuggestGetToggleButtonPropsOptions,
  ) => any
  getLabelProps: (options?: UseSlateSuggestGetLabelPropsOptions) => any
  getMenuProps: (
    options?: UseSlateSuggestGetMenuPropsOptions,
    otherOptions?: GetPropsCommonOptions,
  ) => any
  getItemProps: (options: UseSlateSuggestGetItemPropsOptions<Item>) => any
  getInputProps: (
    options?: UseSlateSuggestGetInputPropsOptions,
    otherOptions?: GetPropsCommonOptions,
  ) => any
  getComboboxProps: (
    options?: UseSlateSuggestGetComboboxPropsOptions,
    otherOptions?: GetPropsCommonOptions,
  ) => any
}

export interface UseSlateSuggestActions<Item> {
  reset: () => void
  openMenu: () => void
  closeMenu: () => void
  toggleMenu: () => void
...
export type UseSlateSuggestReturnValue<Item> = UseSlateSuggestState<Item> &
  UseSlateSuggestPropGetters<Item> &
  UseSlateSuggestActions<Item>

export interface UseSlateSuggestInterface {
  <Item>(props: UseSlateSuggestProps<Item>): UseSlateSuggestReturnValue<Item>
  stateChangeTypes: {
    InputKeyDownArrowDown: UseSlateSuggestStateChangeTypes.InputKeyDownArrowDown
    InputKeyDownArrowUp: UseSlateSuggestStateChangeTypes.InputKeyDownArrowUp
    InputKeyDownEscape: UseSlateSuggestStateChangeTypes.InputKeyDownEscape
    InputKeyDownHome: UseSlateSuggestStateChangeTypes.InputKeyDownHome
    InputKeyDownEnd: UseSlateSuggestStateChangeTypes.InputKeyDownEnd
    InputKeyDownEnter: UseSlateSuggestStateChangeTypes.InputKeyDownEnter
    InputBlur: UseSlateSuggestStateChangeTypes.InputBlur
    MenuMouseLeave: UseSlateSuggestStateChangeTypes.MenuMouseLeave
    ItemMouseMove: UseSlateSuggestStateChangeTypes.ItemMouseMove
    ItemClick: UseSlateSuggestStateChangeTypes.ItemClick
    ToggleButtonClick: UseSlateSuggestStateChangeTypes.ToggleButtonClick
    FunctionToggleMenu: UseSlateSuggestStateChangeTypes.FunctionToggleMenu
    FunctionOpenMenu: UseSlateSuggestStateChangeTypes.FunctionOpenMenu
    FunctionCloseMenu: UseSlateSuggestStateChangeTypes.FunctionCloseMenu
    FunctionSetHighlightedIndex: UseSlateSuggestStateChangeTypes.FunctionSetHighlightedIndex
    FunctionSelectItem: UseSlateSuggestStateChangeTypes.FunctionSelectItem
    FunctionReset: UseSlateSuggestStateChangeTypes.FunctionReset
    ControlledPropUpdatedSelectedItem: UseSlateSuggestStateChangeTypes.ControlledPropUpdatedSelectedItem
  }
}

export const useSlateSuggest: UseSlateSuggestInterface
